...
Beyond the Anaconda distribution of Python, the following packages need to be imported :
* opencv-python
* pillow
* tqdm
* h5py
...
Welcome to the Convolutional Neural Networks (CNN) project in the Data Science Nanodegree! In this project, we will learn how to build a pipeline that can be used within a web or mobile app to process real-world, user-supplied images.  Given an image of a dog, our algorithm will identify an estimate of the canine’s breed.  If supplied an image of a human, the code will identify the resembling dog breed.
